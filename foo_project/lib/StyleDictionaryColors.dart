...
class StyleDictionaryColors {
  StyleDictionaryColors._();
    ...
    static const colorFontLight = Color(0xFFEAEAEA);
    static const colorPrimary = Color(0xFFCA0AE5);
    static const colorPurple = Color(0xFFCA0AE5);
    static const colorSecondary = Color(0xFF1CE6FF);
